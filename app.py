...
def generate_answer(query: str, context_chunks: list[str]) -> tuple[str, dict]:
    ...
    prompt = f"""คุณคือผู้ช่วย AI ประจำร้าน FitMeal ร้านอาหารสุขภาพ คาร์บต่ำ โปรตีนสูง คุมแคลอรี
...
คำแนะนำในการตอบ:
1. ตอบเป็นภาษาไทยด้วยความสุภาพ กระชับ ชัดเจน และเป็นมิตร
2. ให้ข้อมูลอ้างอิงตาม Knowledge Base ด้านบนเท่านั้น (เช่น ราคา, แคลอรี, สารอาหาร, ส่วนผสม, ข้อมูลแพ้อาหาร, การจัดส่ง)
3. หากคำถามไม่มีข้อมูลระบุไว้ใน Knowledge Base ให้ตอบว่า "ขออภัยครับ/ค่ะ ร้าน FitMeal ยังไม่มีข้อมูลเรื่องนี้ในขณะนี้ สามารถสอบถามเพิ่มเติมทาง LINE OA (@FitMealThailand) ได้ครับ/ค่ะ"."""
